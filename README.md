...
<h1 align="center">Projet 8 Openclassrooms - Projet Kasa</h1>

###

<h3 align="center">Créez une application web de location immobilière avec React</h3>

###

<div align="center">
  <img height="200" src="https://zupimages.net/up/23/43/xxav.png"  />
</div>
...
<p>📚 <strong>Action 1 :</strong> Initialisez le projet</p>
<p>📚 <strong>Action 2 :</strong> Ajoutez React Router</p>
<p>📚 <strong>Action 3 :</strong> Créez le routeur et les différentes pages de l’application</p>
<p>📚 <strong>Action 4 :</strong> Créez la page d’accueil</p>
<p>📚 <strong>Action 5 :</strong>  Créez la page À propos</p>
<p>📚 <strong>Action 6 :</strong>  Créez la page d’erreur</p>
<p>📚 <strong>Action 7 :</strong>  Créez le carrousel de la page de logement</p>
<p>📚 <strong>Action 8 :</strong>  Finalisez la page de logement</p>
<p>📚 <strong>Action 9 :</strong>  Gérez l’erreur sur l’id d’une propriété</p>
<p>📚 <strong>Action 10 :</strong>  Vérifiez l’ensemble de votre site</p>
...
<div align="center">
  ...
  <img width="12" />
  <img src="https://upload.wikimedia.org/wikipedia/commons/f/f1/Vitejs-logo.svg" height="40" alt="javascript logo"  />
  <img width="12" />
...
# Projet-8-openclassrooms-Projet-Kasa
